...
class Statement {
  ...
  getParams(...allowed: string[]) {
    ...
    while (this.tokens[this.line][this.index] && !this.tokens[this.line][this.index].type.includes("Close")) {
      ...
      this.err.stateChecker("type", this.tokens[this.line][this.index++], "Wrong Function declaration Syntax", ...allowed);
      params.push(value);
      this.err.stateChecker("type", this.tokens[this.line][this.index], "Wrong Function declaration Syntax", "Close", "Comma");
  ...
  parseFunc() {
    ...
    this.err.stateChecker("type", this.tokens[this.line][this.index], "Wrong Function Declaration", "Variable");
    let { value } = this.tokens[this.line][this.index++];

    this.err.stateChecker("type", this.tokens[this.line][this.index++], "Open Parentheses are missing", "Open Parentheses");
    ...
    this.err.stateChecker("type", this.tokens[this.line][this.index++], "Close Parentheses are missing", "Close Parentheses");
    this.err.stateChecker("type", this.tokens[this.line][this.index++], "Indented Block is missing", "Start Block");
